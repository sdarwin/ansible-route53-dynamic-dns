...
$webRequest = Invoke-WebRequest -Headers @{"x-api-key"="$myAPIKEY"} -URI $getURL -UseBasicParsing
...
$webRequest = Invoke-WebRequest -Headers @{"x-api-key"="$myAPIKEY"} -URI $setURL -UseBasicParsing
